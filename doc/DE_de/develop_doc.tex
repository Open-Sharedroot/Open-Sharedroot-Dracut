...
In einem Script \texttt{check} wird eine Funktion \texttt{check()} definiert. Das Scrip \texttt{check} sollte 0 (null) zurückgeben, wenn alle Bedingungen wefüllt sind. Wird ein anderer Wert zurückgegeben, wird das Modul nicht von Darcut geladen.

Mit dem Schlüsselwort \texttt{inst\_simple} werden Dateinen in das initramfs kopiert/installiert.

Mit dem Schlüßelwort \texttt{dracut_install} werden Software-Pakete in die ramsf-Umgebung installiert bzw. zur Verfühgung gestellt. 
