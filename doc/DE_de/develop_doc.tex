...
\subsection{Automatisch generierte  Schnittstellen- und Code-dokumentation}
...
Die wichtigsten -- und zu verwendenen -- Schlüsselwörter sind:

\begin{description}
 \item[NAME] Name der Funtion mit Kurzbeschreibung. 
 \item[COPYRIGHT] Urheber und Lizenzvermerk. Z.B. "`(c) <year>-<year> by <company/person>"'
 \item[SYNOPSIS , USAGE] Beschreibung des gebrauchs.
 \item[FUNCTION , DESCRIPTION , PURPOSE] Beschreibung was es tut.
 \item[INPUTS , ARGUMENTS , OPTIONS , PARAMETERS , SWITCHES] Erwartete Parameter.
 \item[OUTPUT , SIDE EFFECTS] Wechselwirkungen.
 \item[RESULT , RETURN VALUE] Rückgabewert.
 \item[EXAMPLE] Bespiel für die nutzung.
 \item[NOTES] Anmerkungen.
 \item[WARNINGS , ERRORS] Mögliche Fehlermeldungen und Wahrnungen.
 \item[BUGS] Bekannte Fehler.
 \item[TODO , IDEAS] Offene Punkte und Ideen.
 \item[PORTABILITY] Anmerkungen System-/Distributions-Abhängigkeiten.
 \item[SEE ALSO] Verweis auf andere Funktionen oder Dokus.
 \item[TAGS] Kategorie. Macht Sinn für die Pseudo-Namensräume. Hier wird also
 der Namensraum genannt.
 \item[USES , CHILDREN] Welche Funktionen werden verwendet/benötigt.
 \item[USED BY , PARENTS] Wer oder Was ist auf diese Funktion angewiesen.
 \item[COMMANDS] Komandobeschreibungen.
 \item[SOURCE] Sollte am Ende des Funktionskommentar stehen. Zeigt an, das der
 eigentlich Funktionscode folgt und berücksichtigt werden soll.
 \end{description}
...
\subsubsection{Nicht verwendete Schlüsselwörter}

\begin{description}

 \item[AUTHOR] Autor(en) namen. Ist in Git besser nachvolziebar.
 \item[CREATION DATE] Erstellungsdatum. Unintersant und ggf. in Git zu sehen.
 \item[MODIFICATION HISTORY , HISTORY] Änderungsgeschichte. Siehe Git.
 \item[DIAGNOSTICS]
 \item[METHODS , NEW METHODS] Dash ist nicht OOP.
 \item[ATTRIBUTES , NEW ATTRIBUTES] Dash ist nicht OOP.
 \item[DERIVED FROM] Dash ist nicht OOP.
 \item[DERIVED BY] Dash ist nicht OOP.
